...
import { k, f as f$1 } from "../app.973bcb23.mjs";
...
var y = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  ...
  }), () => [h("div", { class: "vue-playground-wrapper" }, [e.title ? h("div", { class: "header" }, decodeURIComponent(e.title)) : null, h("div", { class: "repl-container" }, [n.value ? h(k, { class: "preview-loading", height: 192 }) : null, a.value ? h(a.value, { store: o.value, autoResize: true, ...l.value, layout: "horizontal" }) : null])])];
} });
export {
  y as default
};
